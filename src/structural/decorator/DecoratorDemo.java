...
public class DecoratorDemo {
	...
	public static void main(String[] args)
	{
		...
		System.out.println(vegFood.prepareFood()+" price "+vegFood.foodPrice() );
		
		Food nonVeg = new NonVegFood(vegFood);
		System.out.println(nonVeg.prepareFood()+" price "+nonVeg.foodPrice() );
	}
