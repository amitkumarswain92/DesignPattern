 ...
 * to actual target application. Filters can do the authentication/ authorization/ logging 
 * or tracking of request and then pass the requests to corresponding handlers. 
 * Following are the entities of this type of design pattern.

Filter - Filter which will performs certain task prior or after execution of request 
by request handler.
